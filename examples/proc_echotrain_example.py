...
data, timescale, dic = processing.split_echotrain(datapath='./example_data/119Sn_SnO2_double_echo_cpmg/1100/pdata/1',
...
ppm_scale_mc, hz_scale_mc, data_mc = processing.read_brukerproc('./example_data/119Sn_SnO2_double_echo_cpmg/1101/pdata/11')
