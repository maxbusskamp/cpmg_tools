...
ppm_scale1, hz_scale1, data1, dic1 = processing.read_brukerfid('/home/m_buss13/ownCloud/nmr_data/development/195Pt_Pt-Mix_WCPMG-MAS_23.02.21/2999/pdata/1', dict=True)
ppm_scale2, hz_scale2, data2, dic2 = processing.read_brukerfid('/home/m_buss13/ownCloud/nmr_data/development/195Pt_Pt-Mix_WCPMG-MAS_23.02.21/3999/pdata/1', dict=True)
...
datasets = [(ppm_scale1, hz_scale1, data1),
            (ppm_scale2, hz_scale2, data2),
            ]
...
# Combine Datsets
dataset_array = processing.combine_stepped_aq(datasets, set_sw=2000e3, precision_multi=8, verbose=True)
...
# Combine Datsets
dataset_array_mc = processing.combine_stepped_aq(datasets_mc, set_sw=2000e3, precision_multi=8, verbose=True)
print('Finished combining Datasets')

# Just some plotting for the example
plt.figure()
plt.plot(dataset_array_mc[:,0], dataset_array_mc[:,1], lw=1.0, c='r', label='Combined Spectrum')
plt.plot(dataset_array[:,0], dataset_array[:,1], lw=1.0, c='k', label='Combined Spectrum')
plt.yticks([])
